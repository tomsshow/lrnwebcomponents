...
[![Build Status](https://travis-ci.org/lrnwebcomponents/lrnwebcomponents.svg?branch=master)](https://travis-ci.org/lrnwebcomponents/lrnwebcomponents)
[![Dependency Status](https://img.shields.io/david/lrnwebcomponents/lrnwebcomponents.svg?style=flat)](https://david-dm.org/lrnwebcomponents/lrnwebcomponents)
[![Published on webcomponents.org](https://img.shields.io/badge/webcomponents.org-published-blue.svg)](https://www.webcomponents.org/author/lrnwebcomponents)
...
```bash
$ git clone git@github.com:lrnwebcomponents/lrnwebcomponents.git
$ cd lrnwebcomponents
$ yarn install
$ yarn start
```
